global using FakeConsumer = Navi.Aws.Tests.Builders.FakeConsumer<string>;
global using TestConsumer =
    Navi.Aws.Tests.Builders.FakeMessageConsumer<
        Navi.Aws.Tests.Builders.TestMessage>;
global using FakeMessageConsumer = Navi.Aws.Tests.Builders.FakeMessageConsumer<string>;
