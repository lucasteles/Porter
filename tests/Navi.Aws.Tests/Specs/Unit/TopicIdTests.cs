...
{
    public static readonly NaviTopicNameConfig EmptyConfig =
    ...
    public void ShouldNormalizeNameWithPrefixAndSufix()
    {
        ...
        var topic = new TopicId(name, new NaviTopicNameConfig { Prefix = prefix, Suffix = sufix, Source = "source" });
    ...
    public void ShouldNormalizeQueueName()
    {
        ...
        var topic = new TopicId(name, new NaviTopicNameConfig { Prefix = prefix, Suffix = suffix, Source = source });
    ...
    public void ShouldNotHaveUnderscoreAtEdges(string prefix, string suffix)
    {
        ...
        var topic = new TopicId(name, new NaviTopicNameConfig { Prefix = "", Suffix = suffix, Source = source });
