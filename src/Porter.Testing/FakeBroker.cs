...
sealed class InMemoryBroker : IConsumeDriver, IProduceDriver, IConsumerJob, IPorterResourceManager,
    IFakeBroker
{
    ...
    readonly IPorterClock porterClock;
    ...
    public InMemoryBroker(
        ...
        IPorterClock porterClock)
    {
        this.consumerFactory = consumerFactory;
        this.Serializer = serializer;
        this.config = config.Value;
        this.porterClock = porterClock;
