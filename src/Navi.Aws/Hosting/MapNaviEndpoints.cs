...
static class NaviEndpoints
{
        ...
        NaviConfig config)
    {
        ...
        var serializer = app.ServiceProvider.GetRequiredService<INaviMessageSerializer>();
    ...
    static string GenerateJsonSample(Type type, INaviMessageSerializer serializer)
    {
        try
        {
