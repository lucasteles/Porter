...
///
/// </summary>
public class NaviTopicNameConfig
{
    /// <summary>
    ///
    /// </summary>
    ...
    internal NaviTopicNameConfig FromOverride(TopicNameOverride? @override) =>
        new()
        {
            Source = Source,
...
public class NaviConfig : NaviTopicNameConfig
{
...
public class ConfigureNaviOption : IConfigureOptions<NaviConfig>
{
    const string ConfigSection = "Navi";
    readonly IConfiguration? configuration;
    readonly IHostEnvironment? hostEnvironment;

    public ConfigureNaviOption(
    ...
    public void Configure(NaviConfig options)
    {
        ...
        if (Environment.GetEnvironmentVariable("NAVI_AWS_REGION") is
            { Length: > 0 } region)
            options.Region = region;
    }
}

sealed record NaviAwsCredentialWrapper(AWSCredentials Credentials);
