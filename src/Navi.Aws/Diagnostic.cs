...
using Navi.Models;
using static Navi.NaviTelemetry;
...
public static class NaviTelemetry
{
    public const string SourceName = "A55.Navi";
}
...
class Diagnostics : IDiagnostics
{
    ...
    public Diagnostics(IOptions<NaviConfig> config) => this.config = config.Value;
